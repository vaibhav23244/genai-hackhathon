...
from uploader.uploader_nodes.chunking_embedding import chunking_embedding
...
uploader_workflow.add_node("chunking_embedding", chunking_embedding)
...
uploader_workflow.add_edge("doc_categorizer", "chunking_embedding")
uploader_workflow.add_edge("not_valid", END)    
uploader_workflow.add_edge("summarizer", END)
uploader_workflow.add_edge("explanation", END)
uploader_workflow.add_edge("chunking_embedding", END)